...
template<class Vertex>
Graph<Vertex>::Graph(int num_vertices)
{
...
template<class Vertex>
void Graph<Vertex>::initialize_graph(int num_vertices)
{
    this->curr_vertex  = 0;
    ...
    this->edges        = new int *[num_vertices];
...
//       (in case the edge did not exist) 
 template<class Vertex>
 void Graph<Vertex>::add_edge(Vertex from, Vertex to, int weight)
 {
     int row;
     int col;
